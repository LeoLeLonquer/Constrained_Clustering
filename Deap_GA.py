...
#Creates a dictionnary of easy to access cannot link
print(Dico_fortement_connexe)
print(cl_rules)


IND_SIZE = len(Dico_fortement_connexe) # Number of connex sets
POP_SIZE = 100
nb_cluster = 3 # ! try to bad score when not 5 clusters
...
def main():
    ...
    for g in range(NGEN):
        ...
        if g % 100 == 0: #wipe out invalid pop
